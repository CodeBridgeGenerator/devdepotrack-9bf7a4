...
import DevinfoPage from "../DevinfoPage/DevinfoPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("devinfo");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "devinfo",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "devinfo" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "devinfo",
                      "text-black": props?.currentActiveTab2 !== "devinfo",
                    })}
                  >
                  Devinfo
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "devinfo",
                      "text-yellow-700": props?.currentActiveTab2 !== "devinfo",
                    })}
                  >
